@WEOS-1038
Feature: As a CSR, I should be able to update a Request so that I can change the details of a request
  ...
  Scenario: Updating a request with custom fields
    ...
    When Lynissa selects the edit button
  ...
  Scenario: Select different request type
    Given Lynissa is viewing a Request with id 2
    And Lynissa selects the edit button
